...
<meta charset="UTF-8">
<script type="text/javascript" src="JS/onclock.JS"></script>
<table width="788"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="6px" colspan="2" valign="top" bgcolor="#000000"></td>
  </tr>
  <tr>
    <td width="270" height="79" valign="top" bgcolor="#0885B1"><img src="images/logo.jpg" width="276" height="79" /></td>
    <td width="520" valign="top" bgcolor="#0885B1"><table width="100%" height="36"  border="0" cellpadding="0" cellspacing="0">
      <tr align="center">
...
<table width="788" height="36" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="788"><table width="100%" height="36"  border="0" align="center" cellpadding="0" cellspacing="0">
      <tr align="center">
        <td width="9%"><a href="#">本站首页</a></td>
        <td width="2%"><img src="images/shop_09.gif" width="1" height="17" /></td>
        <td width="15%"><a href="#">新品上市</a></td>
        <td width="1%"><img src="images/shop_09.gif" width="1" height="17" /></td>
        <td width="14%"><a href="#">特价商品</a></td>
        <td width="1%"><img src="images/shop_09.gif" width="1" height="17" /></td>
        <td width="11%"><a href="#">畅销商品</a></td>
        <td width="1%"><img src="images/shop_09.gif" width="1" height="17" /></td>
        <td width="10%"><a href="#">购物车</a></td>
        <td width="1%"><img src="images/shop_09.gif" width="1" height="17" /></td>
        <td width="15%"><a href="#">查看订单</a></td>
        <td width="1%"><img src="images/shop_09.gif" width="1" height="17" /></td>
        <td width="14%"><a href="#">会员资料修改</a></td>
        <td width="2%">&nbsp;</td>
        </tr>
    </table></td>
  </tr>
