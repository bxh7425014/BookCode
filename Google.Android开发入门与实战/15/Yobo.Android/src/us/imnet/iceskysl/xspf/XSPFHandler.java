...
////
////			droidDB.insertFeed(playlist.getTitle(), new URL(url
////					.toExternalForm()), null);
//
//		} catch (Exception e) {
...
//			Playlist playlist = parser.getPlaylist();
//
//			Iterator<Track> itList = (Iterator<Track>) ((ArrayList<Track>) playlist
//					.getTracks()).iterator();
//
...
//
////					droidDB.insertArticle(feedp.feedId, track.getTitle(),
////							new URL(track.getLocation()), imageUrl);
