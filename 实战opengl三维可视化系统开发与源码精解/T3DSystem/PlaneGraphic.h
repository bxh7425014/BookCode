...
// Dialog Data
	...
	enum { IDD = IDD_DIALOG_PLANEGRAPHIC };
...
protected:
	...
	afx_msg void OnZoominoutdynamic();
	afx_msg void OnGraphMove1();
	afx_msg void OnGraphMove3();
	afx_msg void OnMenuPlaneFirstscreen();
	afx_msg void OnMenuPlanePrescreen();
	afx_msg void OnMenuPlaneNextscreen();
	afx_msg void OnMenuPlaneOutcad();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
private:
	void LoadCurveData();
