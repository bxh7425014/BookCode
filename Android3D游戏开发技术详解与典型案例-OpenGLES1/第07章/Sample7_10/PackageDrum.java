...
public class PackageDrum
{
	...
	public PackageDrum(MyGLSurfaceView surface)
	{
		...
		hyperboloid=new DrawHyperboloid(6f,2f,2f,3f,10,18,surface.mRenderer.bodyTextureId);//创建圆柱体
        circle=new DrawCircle(cylinder.R,12f,surface.mRenderer.circleTextureId);
	}
	...
	public void onDraw(GL10 gl)
	{
        ...
        gl.glPushMatrix();
        initMaterial(gl);
        gl.glTranslatef(0, cylinder.height*0.5f, 0);
