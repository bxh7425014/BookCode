...
public class AuthorizeActivity extends Activity {
	...
	private static final String CONSUMER_KEY = "2081498321";// 替换为开发者的appkey，例如"1646212960";
	private static final String CONSUMER_SECRET = "7907ee613510bb7d3b2ce8beed302dd1";// 替换为开发者的appkey，例如"94098772160b6f8ffc1315374d8861f9";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String token="2.00fC1XMDZnkrQCbfbe5766630Y4Kge";
		...
		mLogin.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (v == mLogin) {
					...
					// Oauth2.0
					// 隐式授权认证方式
					weibo.setRedirectUrl("http://baidu.com");// 此处回调页内容应该替换为与appkey对应的应用回调页
